use crate::fontdue::platform::{ceil, floor};
use crate::fontdue::unicode::{linebreak_property, read_utf8, wrap_mask};
use crate::fontdue::{Font, ZERO_METRICS};
...
impl Layout {
    ...
    pub fn layout_horizontal<T: Borrow<Font>>(
        ...
        for (current_index, glyph) in output.iter_mut().enumerate() {
